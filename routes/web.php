...
Route::middleware(['isLogin', 'addUserToView'])->group(function () {
    // Dasboard
    ...
    Route::patch('/{id}/booking-update', [BookingController::class, 'update'])->name('booking.update');
    ...
    // PKL Nilai
    Route::get('/pkl-nilai', [PKLNilaiController::class, 'index'])->name('pkl-nilai.index');
    Route::get('/pkl-nilai-create', [PKLNilaiController::class, 'create'])->name('pkl-nilai.create');
    Route::post('/pkl-nilai-store', [PKLNilaiController::class, 'store'])->name('pkl-nilai.store');
    Route::get('/{id}/pkl-nilai-edit', [PKLNilaiController::class, 'edit'])->name('pkl-nilai.edit');
    Route::patch('/{id}/pkl-nilai-update', [PKLNilaiController::class, 'update'])->name('pkl-nilai.update');
    Route::delete('/{id}/pkl-nilai-destroy', [PKLNilaiController::class, 'destroy'])->name('pkl-nilai.destroy');
    ...
    //Tidak Dipakai
    // Route::delete('/{id}/sempro-mhs-kap-destroy', [SemproMahasiswaKapController::class, 'destroy'])->name('sempro-mhs-kap.destroy');

    //Sempro Mahasiswa Nilai
    Route::get('/sempro-nilai', [SemproNilaiController::class, 'index'])->name('sempro-nilai.index');
    Route::get('/sempro-nilai-create', [SemproNilaiController::class, 'create'])->name('sempro-nilai.create');
    Route::post('/sempro-nilai-store', [SemproNilaiController::class, 'store'])->name('sempro-nilai.store');
    Route::get('/{id}/sempro-nilai-edit', [SemproNilaiController::class, 'edit'])->name('sempro-nilai.edit');
    Route::patch('/{id}/sempro-nilai-update', [SemproNilaiController::class, 'update'])->name('sempro-nilai.update');
    Route::delete('/{id}/sempro-nilai-destroy', [SemproNilaiController::class, 'destroy'])->name('sempro-nilai.destroy');
});
