        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Form Edit Kelas</div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <form class="form form-vertical" method="POST"
                                action="{{ route('kelas.update', $kelas->id_kelas) }}">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="kode_kelas" name="kode_kelas"
                                            ...
                                            value="{{ old('kode_kelas', $kelas->kode_kelas) }}" placeholder=".">
                                        @error('kode_kelas')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_kelas" name="nama_kelas"
                                            ...
                                            value="{{ old('nama_kelas', $kelas->nama_kelas) }}" placeholder=".">
                                        @error('nama_kelas')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <select id="prodi_id" name="prodi_id"
                                            ...
                                            @foreach ($prodi as $item)
                                                <option value="{{ $item->id_prodi }}"
                                                    {{ $kelas->prodi_id == $item->id_prodi ? 'selected' : '' }}>
                                                    {{ $item->nama_prodi }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="smt_thnakd_id" name="smt_thnakd_id"
                                            ...
                                            @foreach ($smt_thnakd as $item)
                                                <option value="{{ $item->id_smt_thnakd }}"
                                                    {{ $kelas->smt_thnakd_id == $item->id_smt_thnakd ? 'selected' : '' }}>
                                                    {{ $item->nama_smt_thnakd }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('smt_thnakd_id')
