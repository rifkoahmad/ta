                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="tipe" name="tipe"
                                            ...
                                            value="{{ old('tipe') }}" placeholder="Masukkan tipe booking">
                                        @error('tipe')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="status_booking" name="status_booking"
                                            ...
                                            <option value="1" {{ old('status_booking') == '1' ? 'selected' : '' }}>PKL
                                            </option>
                                            <option value="2" {{ old('status_booking') == '2' ? 'selected' : '' }}>
                                                SEMPRO</option>
                                            <option value="3" {{ old('status_booking') == '3' ? 'selected' : '' }}>TA
                                            </option>
                                            {{-- <option value="0" {{ old('status_booking') == '0' ? 'selected' : '' }}>
                                                Unknown</option> --}}
                                        </select>
