...
@section('title', 'Tambah Log Book PKL')
@section('content')
    <!-- Main Content -->
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Form Log Book PKL</div>
                </div>
            </div>
                            ...
                            <form class="form form-vertical" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="kegiatan" name="kegiatan" class="form-control @error('komentar') is-invalid @enderror">{{ old('komentar') }}</textarea>
                                        @error('kegiatan')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="dokumen_laporan">Choose file</label>
                                        </div>
                                    ...
                                    <div class="form-group" style="display: none;">
                                        ...
                                        <textarea id="komentar" name="komentar" class="form-control @error('komentar') is-invalid @enderror">{{ old('komentar') }}</textarea>
                                        @error('komentar')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
