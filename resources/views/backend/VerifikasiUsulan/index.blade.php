...
@section('title', 'Verifikasi Usulan Tempat PKL')
@section('content')
    <!-- Main Content -->
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Verifikasi Usulan Tempat PKL</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div>
                    <div class="breadcrumb-item">Data Varifikasi Usulan Tempat PKL</div>
                </div>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Tabel Verifikasi Usulan Tempat PKL</h2>
                <p class="section-lead">
                    Data verifikasi usulan tempat praktik kerja lapangan mahasiswa
                </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="d-flex mt-1">
                                                            <a href="{{ route('verifikasi-usulan-pkl.edit', $item->id_usulan) }}"
