        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('sempro-nilai-pembimbing.index') }}">Data PKL Sempro Nilai</a></div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <form class="form form-vertical" method="POST" enctype="multipart/form-data"
                                action="{{ route('sempro-nilai-pembimbing.store') }}">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" name="sebagai" value="{{$sebagai}}">
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <a href="{{ route('sempro-nilai-pembimbing.index') }}" class="btn btn-warning">
