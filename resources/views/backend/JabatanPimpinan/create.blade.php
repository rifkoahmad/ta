...
@section('title', 'Add Jabatan Pimpinan')
@section('content')
    <!-- Main Content -->
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Form Jabatan Pimpinan</div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <form class="form form-vertical" method="POST" enctype="multipart/form-data"
                                action="{{ route('jabatan-pimpinan.store') }}">
                                @csrf
                                <div class="card-header">
                                    <h4>Tambah Data Jabatan Pimpinan</h4>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="kode_jabatan_pimpinan" name="kode_jabatan_pimpinan"
                                            ...
                                            value="{{ old('kode_jabatan_pimpinan') }}" placeholder="Masukkan Kode Jabatan">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_jabatan_pimpinan" name="nama_jabatan_pimpinan"
                                            ...
                                            value="{{ old('nama_jabatan_pimpinan') }}" placeholder="Masukkan Nama Jabatan">
