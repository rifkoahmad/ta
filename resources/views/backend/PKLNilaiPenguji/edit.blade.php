        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('pkl-nilai-penguji.index') }}">Data PKL Nilai</a></div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <form class="form form-vertical" method="POST" enctype="multipart/form-data"
                                action="{{ route('pkl-nilai-penguji.update', $pklNilai->id_pkl_nilai) }}">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <a href="{{ route('pkl-nilai-penguji.index') }}" class="btn btn-warning">
