                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="mt-3">
                                    @if ($pkl)
                                        <a href="{{ route('pkl-nilai-penguji.create') }}" class="btn btn-success">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="d-flex mt-1">
                                                            <a href="{{ route('pkl-nilai-penguji.edit', $item->id_pkl_nilai) }}"
                                                                class="btn btn-outline-primary"><i
                                                                    class="fas fa-edit"></i></a>
                                                            <form
                                                                action="{{ route('pkl-nilai-penguji.destroy', $item->id_pkl_nilai) }}"
