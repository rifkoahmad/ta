...
@section('title', 'Sempro Mahasiswa')
@section('content')
    <!-- Main Content -->
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Data Seminar Proposal Mahasiswa</div>
                </div>
            </div>
            ...
            <div class="section-body">
                <h2 class="section-title">Table Seminar Proposal Mahasiswa</h2>
                                                    ...
                                                    <td class="align-middle">
                                                        @if ($item->status_ver_sempro != 1 && $item->status_judul_sempro != 1 && $item->status_sempro != 1)
                                                            <div class="d-flex mt-1">
                                                                <a href="{{ route('sempro-mhs.edit', $item->id_sempro_mhs) }}"
                                                                    class="btn btn-outline-primary">
