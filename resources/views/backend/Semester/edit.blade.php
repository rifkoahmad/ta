...
@section('title', 'Edit Semester Tahun Akademik')
@section('content')
    <!-- Main Content -->
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Form Edit Semester Tahun Akademik</div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <form class="form form-vertical" method="POST" enctype="multipart/form-data"
                                action="{{ route('semester.update', $semester->id_smt_thnakd) }}">
                                @csrf
                                @method('PATCH')
                                <div class="card-header">
                                    <h4>Edit Data Semester Tahun Akademik</h4>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="kode_smt_thnakd" name="kode_smt_thnakd"
                                            ...
                                            value="{{ old('kode_smt_thnakd', $semester->kode_smt_thnakd) }}"
                                            placeholder=".">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_smt_thnakd" name="nama_smt_thnakd"
                                            ...
                                            value="{{ old('nama_smt_thnakd', $semester->nama_smt_thnakd) }}"
                                            placeholder=".">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="status_smt_thnakd" name="status_smt_thnakd"
                                            ...
                                            <option value="1"
                                                {{ old('status_smt_thnakd', $semester->status_smt_thnakd) == '1' ? 'selected' : '' }}>
                                                Aktif
                                            </option>
                                            <option value="0"
                                                {{ old('status_smt_thnakd', $semester->status_smt_thnakd) == '0' ? 'selected' : '' }}>
                                                Tidak Aktif
                                            </option>
                                        </select>
